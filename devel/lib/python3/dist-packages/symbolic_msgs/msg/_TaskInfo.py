...
"""autogenerated by genpy from symbolic_msgs/TaskInfo.msg. Do not edit."""
import codecs
import sys
...
class TaskInfo(genpy.Message):
  _md5sum = "4a0d32656f5b9bd118d9cc7e00f8102a"
  _type = "symbolic_msgs/TaskInfo"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vision_msgs/Detection3DArray Detection_3D_Array
...
string data
"""
  __slots__ = ['Detection_3D_Array','Grasp_Pose','Object_List','Object_Feature','Object_Symbolic_Data','Task_Goal']
  _slot_types = ['vision_msgs/Detection3DArray','geometry_msgs/Pose','std_msgs/String[]','std_msgs/String[]','std_msgs/String[]','std_msgs/String[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       Detection_3D_Array,Grasp_Pose,Object_List,Object_Feature,Object_Symbolic_Data,Task_Goal
    ...
    if args or kwds:
      ...
      if self.Detection_3D_Array is None:
        self.Detection_3D_Array = vision_msgs.msg.Detection3DArray()
      ...
      if self.Object_Feature is None:
        self.Object_Feature = []
      if self.Object_Symbolic_Data is None:
        self.Object_Symbolic_Data = []
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3I().pack(_x.Detection_3D_Array.header.seq, _x.Detection_3D_Array.header.stamp.secs, _x.Detection_3D_Array.header.stamp.nsecs))
      _x = self.Detection_3D_Array.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.Detection_3D_Array.detections)
      buff.write(_struct_I.pack(length))
      for val1 in self.Detection_3D_Array.detections:
        _v1 = val1.header
        _x = _v1.seq
      ...
      for val1 in self.Object_Feature:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.Object_Symbolic_Data)
      buff.write(_struct_I.pack(length))
      for val1 in self.Object_Symbolic_Data:
        _x = val1.data
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.Task_Goal)
      buff.write(_struct_I.pack(length))
      for val1 in self.Task_Goal:
        _x = val1.data
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if self.Object_Symbolic_Data is None:
        self.Object_Symbolic_Data = None
      if self.Task_Goal is None:
        self.Task_Goal = None
      end = 0
      _x = self
      ...
      (_x.Detection_3D_Array.header.seq, _x.Detection_3D_Array.header.stamp.secs, _x.Detection_3D_Array.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      ...
      if python3:
        self.Detection_3D_Array.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.Detection_3D_Array.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.Detection_3D_Array.detections = []
      for i in range(0, length):
        ...
        self.Detection_3D_Array.detections.append(val1)
      _x = self
      start = end
      end += 56
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1.data = str[start:end]
        self.Object_Symbolic_Data.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.Task_Goal = []
